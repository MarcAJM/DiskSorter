...
// Delays:
int black_delay = 1650;
int white_delay = 2800;
int kaun_delay = 5000;
...
void loop() {
  ...
  if ((black_disks + white_disks) <= 3) {
    ...
    bool black = ((r >= 800 && r <= 880) && (g >= 1900 && g <= 2100) && (b >= 1500 && b <= 1700));
    bool white = ((r >= 380 && r <= 430) && (g >= 650 && g <= 750) && (b >= 520 && b <= 680));
    bool air = ((r >= 650 && r <= 780) && (g >= 1800 && g <= 2010) && (b >= 1395 && b <= 1550));
